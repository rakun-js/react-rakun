(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rakun'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'rakun', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactRakun = {}, global.Rakun, global.React));
})(this, (function (exports, rakun, React) { 'use strict';
  ...
  var RakunSnapshotContext = /*#__PURE__*/React__default["default"].createContext(rakun.mono.then());
  ...
  var useRakunValueLoadable = function useRakunValueLoadable(rakunSource) {
    ...
    var loadHandler = React.useCallback( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(promise) {
        var contents;
    ...
    var load = React.useCallback(function () {
      try {
        ...
        if (rakunSource[rakun.WrappedValue_OPAQUE] == 'flux') {
          promiseOrValue = context.then(rakunSource).block();
        } else {
          promiseOrValue = context.then(rakunSource).blockFirst();
        }
        if (rakun.isPromise(promiseOrValue)) {
          loadHandler(promiseOrValue);
          return {
            state: 'loading',
            contents: promiseOrValue.then(function (value) {
              return value;
            })
          };
        } else {
  ...
  var useRakunValue = function useRakunValue(rakunSource) {
  ...
  exports.useRakunValue = useRakunValue;
